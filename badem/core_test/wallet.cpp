...
TEST (wallet, state_implicit_generate)
{
	...
	system.nodes[0]->ledger.state_block_parse_canary = genesis.hash ();
	{
		...
		rai::state_block block (rai::test_genesis_key.pub, genesis.hash (), rai::test_genesis_key.pub, rai::genesis_amount - rai::kBADEM_ratio, rai::test_genesis_key.pub, rai::test_genesis_key.prv, rai::test_genesis_key.pub, 0);
