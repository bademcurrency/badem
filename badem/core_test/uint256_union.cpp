...
TEST (uint128_union, balance_format)
{
	...
	ASSERT_EQ ("123,456,789.12", badem::amount (badem::BDM_ratio * 123456789 + badem::bademcik_ratio * 123).format_balance (badem::BDM_ratio, 2, true));
	ASSERT_EQ ("12-3456-789+123", badem::amount (badem::BDM_ratio * 123456789 + badem::bademcik_ratio * 123).format_balance (badem::BDM_ratio, 4, true, std::locale (std::cout.getloc (), new test_punct)));
}
